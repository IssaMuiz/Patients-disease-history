const Leftsidebar = () => {
  ...
  return (
    <aside className="fixed hidden lg:flex bg-white left-0 top-0 bottom-0 w-[300px] mt-24 rounded-xl overflow-scroll ml-5 overflow-x-hidden scrollbar z-10">
      <div className="flex items-center pt-52 flex-col justify-center">
        <div className="flex justify-between font-semibold text-lg ml-10 p-4">
          <p>Patients</p>
          <img
