const Leftsidebar = () => {
  ...
  return (
    <aside className="fixed hidden xl:flex bg-white left-0 top-0 bottom-0 w-[300px] mt-24 rounded-xl overflow-scroll ml-10 overflow-x-hidden scrollbar z-10">
      <div className="flex font-semibold text-lg p-2 items-center pt-96 flex-col justify-center">
