const Leftsidebar = () => {
  ...
  return (
    <aside className="fixed hidden lg:flex bg-white left-0 top-0 bottom-0 w-[300px] mt-24 rounded-xl overflow-scroll overflow-x-hidden scrollbar z-10">
      <div className="flex items-center pt-32 flex-col justify-center">
