...
const Mainpage = ({ data }) => {
  return (
    <main className="fixed top-0 bottom-0 lg:left-[350px] lg:right-[350px] mt-24 rounded-2xl overflow-y-scroll left-10 right-10 scrollbar bg-white">
      <div className="mx-auto p-5 flex flex-col">
        <div className="p-4">
          <div className="mb-5 font-semibold">
            <h1 className="mb-5">Diagnosis History</h1>
          </div>
          <div className="bg-[#c8c4d4] rounded-2xl  w-full">
            <UserChart />
          </div>
          <div className="flex gap-4 mt-5 text-base w-full">
            <div className="bg-[#E0F3FA] rounded-2xl p-2 w-[300px]">
            ...
            <div className="bg-[#FFE6F1]  rounded-2xl  p-2 w-[300px]">
