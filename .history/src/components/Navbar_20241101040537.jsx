const Navbar = () => {
  return (
    <nav className="flex fixed text-lg mx-10 mt-5 rounded-full bg-white items-center justify-around top-0 left-0 right-0 p-1 mb-14">
      <div className="left-nav hidden lg:flex">
        <div>
          <img className="h-9" src="public/assets/icons/TestLogo.svg" alt="" />
        </div>
      </div>
